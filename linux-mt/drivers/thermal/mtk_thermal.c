 ...
 * These macros could be used for both MT8173, MT2701, and MT2721.
...
const int mt2712_bank_data[MT2712_NUM_SENSORS] = {
	MT2712_TS1, MT2712_TS2, MT2712_TS3, MT2712_TS4
};

const int mt2712_msr[MT2712_NUM_SENSORS_PER_ZONE] = {
...
const int mt2712_mux_values[MT2712_NUM_SENSORS] = { 0, 1, 2, 3 };
