...
#define MT2712_PIN_210_CSI1_RDN0__FUNC_GPIO210 (MTK_PIN_NO(210) | 0)

#define MT2712_PIN_211_CSI1_RDP0__FUNC_GPIO211 (MTK_PIN_NO(211) | 0)

#define MT2712_PIN_212_CSI1_RDN1__FUNC_GPIO212 (MTK_PIN_NO(212) | 0)

#define MT2712_PIN_213_CSI1_RDP1__FUNC_GPIO213 (MTK_PIN_NO(213) | 0)

#define MT2712_PIN_214_CSI1_RCN__FUNC_GPIO214 (MTK_PIN_NO(214) | 0)

#define MT2712_PIN_215_CSI1_RCP__FUNC_GPIO215 (MTK_PIN_NO(215) | 0)

#define MT2712_PIN_216_CSI1_RDN2__FUNC_GPIO216 (MTK_PIN_NO(216) | 0)

#define MT2712_PIN_217_CSI1_RDP2__FUNC_GPIO217 (MTK_PIN_NO(217) | 0)

#define MT2712_PIN_218_CSI1_RDN3__FUNC_GPIO218 (MTK_PIN_NO(218) | 0)

#define MT2712_PIN_219_CSI1_RDP3__FUNC_GPIO219 (MTK_PIN_NO(219) | 0)

#define MT2712_PIN_220_DSI1_TDP0__FUNC_GPIO220 (MTK_PIN_NO(220) | 0)

#define MT2712_PIN_221_DSI1_TDN0__FUNC_GPIO221 (MTK_PIN_NO(221) | 0)

#define MT2712_PIN_222_DSI1_TDP1__FUNC_GPIO222 (MTK_PIN_NO(222) | 0)

#define MT2712_PIN_223_DSI1_TDN1__FUNC_GPIO223 (MTK_PIN_NO(223) | 0)

#define MT2712_PIN_224_DSI1_TCP__FUNC_GPIO224 (MTK_PIN_NO(224) | 0)

#define MT2712_PIN_225_DSI1_TCN__FUNC_GPIO225 (MTK_PIN_NO(225) | 0)

#define MT2712_PIN_226_DSI1_TDP2__FUNC_GPIO226 (MTK_PIN_NO(226) | 0)

#define MT2712_PIN_227_DSI1_TDN2__FUNC_GPIO227 (MTK_PIN_NO(227) | 0)

#define MT2712_PIN_228_DSI1_TDP3__FUNC_GPIO228 (MTK_PIN_NO(228) | 0)

#define MT2712_PIN_229_DSI1_TDN3__FUNC_GPIO229 (MTK_PIN_NO(229) | 0)

#define MT2712_PIN_230_DSI3_TDP0__FUNC_GPIO230 (MTK_PIN_NO(230) | 0)

#define MT2712_PIN_231_DSI3_TDN0__FUNC_GPIO231 (MTK_PIN_NO(231) | 0)

#define MT2712_PIN_232_DSI3_TDP1__FUNC_GPIO232 (MTK_PIN_NO(232) | 0)

#define MT2712_PIN_233_DSI3_TDN1__FUNC_GPIO233 (MTK_PIN_NO(233) | 0)

#define MT2712_PIN_234_DSI3_TCP__FUNC_GPIO234 (MTK_PIN_NO(234) | 0)

#define MT2712_PIN_235_DSI3_TCN__FUNC_GPIO235 (MTK_PIN_NO(235) | 0)

#define MT2712_PIN_236_DSI3_TDP2__FUNC_GPIO236 (MTK_PIN_NO(236) | 0)

#define MT2712_PIN_237_DSI3_TDN2__FUNC_GPIO237 (MTK_PIN_NO(237) | 0)

#define MT2712_PIN_238_DSI3_TDP3__FUNC_GPIO238 (MTK_PIN_NO(238) | 0)

#define MT2712_PIN_239_DSI3_TDN3__FUNC_GPIO239 (MTK_PIN_NO(239) | 0)
