...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> odm_read_and_config_mp_8812a_agc_tab\n"));
	...
	while ((i + 1) < array_len) {
		...
		if (v1 & (BIT(31) | BIT30)) {/*positive & negative condition*/
			...
			if (is_matched)
				odm_config_bb_agc_8812a(p_dm_odm, v1, MASKDWORD, v2);
		}
		i = i + 2;
	}
}
...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> odm_read_and_config_mp_8812a_agc_tab_diff\n"));
...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> odm_read_and_config_mp_8812a_phy_reg\n"));
	...
	while ((i + 1) < array_len) {
		...
		if (v1 & (BIT(31) | BIT30)) {/*positive & negative condition*/
			...
			if (is_matched)
				odm_config_bb_phy_8812a(p_dm_odm, v1, MASKDWORD, v2);
		}
		i = i + 2;
	}
}
...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> odm_read_and_config_mp_8812a_phy_reg_mp\n"));
...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> odm_read_and_config_mp_8812a_phy_reg_pg\n"));
	...
	for (i = 0; i < array_len; i += 6) {
		...
		odm_config_bb_phy_reg_pg_8812a(p_dm_odm, v1, v2, v3, v4, v5, v6);
...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> odm_read_and_config_mp_8812a_phy_reg_pg_asus\n"));
...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> odm_read_and_config_mp_8812a_phy_reg_pg_dni\n"));
...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> odm_read_and_config_mp_8812a_phy_reg_pg_nec\n"));
...
)
{
	...
	ODM_RT_TRACE(p_dm_odm, ODM_COMP_INIT, ODM_DBG_LOUD, ("===> odm_read_and_config_mp_8812a_phy_reg_pg_tplink\n"));
