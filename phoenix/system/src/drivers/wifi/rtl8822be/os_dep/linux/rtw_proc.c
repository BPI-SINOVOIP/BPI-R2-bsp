...
const struct rtw_proc_hdl adapter_proc_hdls[] = {
	...
	RTW_PROC_HDL_SSEQ("tx_amsdu_rate_24g", proc_get_tx_amsdu_rate_24g, proc_set_tx_amsdu_rate_24g),
	RTW_PROC_HDL_SSEQ("tx_amsdu_rate_5g", proc_get_tx_amsdu_rate_5g, proc_set_tx_amsdu_rate_5g),
#endif
#endif /* CONFIG_80211N_HT */
