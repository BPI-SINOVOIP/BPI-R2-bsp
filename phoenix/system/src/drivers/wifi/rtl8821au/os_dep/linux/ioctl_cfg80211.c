...
//#endif //CONFIG_P2P
	...
	} else if ((request->n_channels > 0) && (request->n_channels<= RTW_CHANNEL_SCAN_AMOUNT)) {   // + BUG PHOENIX-529, Edwardwu
...
#ifdef CONFIG_DHC_PATCH
		//Remove by Borg 2014/10/06 for Bug 45201
		//Roll back to original P2P listen setting to fix the issue that
		//P2P Sink is hard to be scanned by P2P Source.
