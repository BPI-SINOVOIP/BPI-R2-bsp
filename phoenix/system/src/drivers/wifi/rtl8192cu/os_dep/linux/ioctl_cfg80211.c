	...
	unsigned int duration, u64 *cookie)
{
	...
	else
	{
        ...
        padapter->wdinfo.listen_channel = remain_ch; /* Bug43180: + Janet 20140522 wpa_cli will send different listen-ch, should not only assign listen-ch in the first time */
	rtw_p2p_set_state(pwdinfo, P2P_STATE_LISTEN);
