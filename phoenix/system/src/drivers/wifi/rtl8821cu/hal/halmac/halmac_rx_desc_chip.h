...
#define GET_RX_DESC_EOSP_8814B(__pRxDesc)    GET_RX_DESC_EOSP_V1(__pRxDesc)
...
#define GET_RX_DESC_MACID_VLD_8814B(__pRxDesc)    GET_RX_DESC_MACID_VLD_V1(__pRxDesc)
#define GET_RX_DESC_MACID_8814B(__pRxDesc)    GET_RX_DESC_MACID_V1(__pRxDesc)
#define GET_RX_DESC_SWPS_RPT_8814B(__pRxDesc)    GET_RX_DESC_SWPS_RPT(__pRxDesc)
#define GET_RX_DESC_PATTERN_IDX_8814B(__pRxDesc)    GET_RX_DESC_PATTERN_IDX_V1(__pRxDesc)
...
#define GET_RX_DESC_EOR_8822C(__pRxDesc)    GET_RX_DESC_EOR(__pRxDesc)
#define GET_RX_DESC_PHYPKTIDC_8822C(__pRxDesc)    GET_RX_DESC_PHYPKTIDC(__pRxDesc)
#define GET_RX_DESC_SWDEC_8822C(__pRxDesc)    GET_RX_DESC_SWDEC(__pRxDesc)
#define GET_RX_DESC_PHYST_8822C(__pRxDesc)    GET_RX_DESC_PHYST(__pRxDesc)
#define GET_RX_DESC_SHIFT_8822C(__pRxDesc)    GET_RX_DESC_SHIFT(__pRxDesc)
#define GET_RX_DESC_QOS_8822C(__pRxDesc)    GET_RX_DESC_QOS(__pRxDesc)
#define GET_RX_DESC_SECURITY_8822C(__pRxDesc)    GET_RX_DESC_SECURITY(__pRxDesc)
#define GET_RX_DESC_DRV_INFO_SIZE_8822C(__pRxDesc)    GET_RX_DESC_DRV_INFO_SIZE(__pRxDesc)
#define GET_RX_DESC_ICV_ERR_8822C(__pRxDesc)    GET_RX_DESC_ICV_ERR(__pRxDesc)
#define GET_RX_DESC_CRC32_8822C(__pRxDesc)    GET_RX_DESC_CRC32(__pRxDesc)
#define GET_RX_DESC_PKT_LEN_8822C(__pRxDesc)    GET_RX_DESC_PKT_LEN(__pRxDesc)

/*RXDESC_WORD1*/

#define GET_RX_DESC_BC_8822C(__pRxDesc)    GET_RX_DESC_BC(__pRxDesc)
#define GET_RX_DESC_MC_8822C(__pRxDesc)    GET_RX_DESC_MC(__pRxDesc)
#define GET_RX_DESC_TY_PE_8822C(__pRxDesc)    GET_RX_DESC_TY_PE(__pRxDesc)
#define GET_RX_DESC_MF_8822C(__pRxDesc)    GET_RX_DESC_MF(__pRxDesc)
#define GET_RX_DESC_MD_8822C(__pRxDesc)    GET_RX_DESC_MD(__pRxDesc)
#define GET_RX_DESC_PWR_8822C(__pRxDesc)    GET_RX_DESC_PWR(__pRxDesc)
#define GET_RX_DESC_PAM_8822C(__pRxDesc)    GET_RX_DESC_PAM(__pRxDesc)
#define GET_RX_DESC_CHK_VLD_8822C(__pRxDesc)    GET_RX_DESC_CHK_VLD(__pRxDesc)
#define GET_RX_DESC_RX_IS_TCP_UDP_8822C(__pRxDesc)    GET_RX_DESC_RX_IS_TCP_UDP(__pRxDesc)
#define GET_RX_DESC_RX_IPV_8822C(__pRxDesc)    GET_RX_DESC_RX_IPV(__pRxDesc)
#define GET_RX_DESC_CHKERR_8822C(__pRxDesc)    GET_RX_DESC_CHKERR(__pRxDesc)
#define GET_RX_DESC_PAGGR_8822C(__pRxDesc)    GET_RX_DESC_PAGGR(__pRxDesc)
#define GET_RX_DESC_RXID_MATCH_8822C(__pRxDesc)    GET_RX_DESC_RXID_MATCH(__pRxDesc)
#define GET_RX_DESC_AMSDU_8822C(__pRxDesc)    GET_RX_DESC_AMSDU(__pRxDesc)
#define GET_RX_DESC_MACID_VLD_8822C(__pRxDesc)    GET_RX_DESC_MACID_VLD(__pRxDesc)
#define GET_RX_DESC_TID_8822C(__pRxDesc)    GET_RX_DESC_TID(__pRxDesc)
#define GET_RX_DESC_MACID_8822C(__pRxDesc)    GET_RX_DESC_MACID(__pRxDesc)

/*RXDESC_WORD2*/

#define GET_RX_DESC_FCS_OK_8822C(__pRxDesc)    GET_RX_DESC_FCS_OK(__pRxDesc)
#define GET_RX_DESC_PPDU_CNT_8822C(__pRxDesc)    GET_RX_DESC_PPDU_CNT(__pRxDesc)
#define GET_RX_DESC_C2H_8822C(__pRxDesc)    GET_RX_DESC_C2H(__pRxDesc)
#define GET_RX_DESC_HWRSVD_8822C(__pRxDesc)    GET_RX_DESC_HWRSVD(__pRxDesc)
#define GET_RX_DESC_WLANHD_IV_LEN_8822C(__pRxDesc)    GET_RX_DESC_WLANHD_IV_LEN(__pRxDesc)
#define GET_RX_DESC_RX_STATISTICS_8822C(__pRxDesc)    GET_RX_DESC_RX_STATISTICS(__pRxDesc)
#define GET_RX_DESC_RX_IS_QOS_8822C(__pRxDesc)    GET_RX_DESC_RX_IS_QOS(__pRxDesc)
#define GET_RX_DESC_FRAG_8822C(__pRxDesc)    GET_RX_DESC_FRAG(__pRxDesc)
#define GET_RX_DESC_SEQ_8822C(__pRxDesc)    GET_RX_DESC_SEQ(__pRxDesc)

/*RXDESC_WORD3*/

#define GET_RX_DESC_MAGIC_WAKE_8822C(__pRxDesc)    GET_RX_DESC_MAGIC_WAKE(__pRxDesc)
#define GET_RX_DESC_UNICAST_WAKE_8822C(__pRxDesc)    GET_RX_DESC_UNICAST_WAKE(__pRxDesc)
#define GET_RX_DESC_PATTERN_MATCH_8822C(__pRxDesc)    GET_RX_DESC_PATTERN_MATCH(__pRxDesc)
#define GET_RX_DESC_RXPAYLOAD_MATCH_8822C(__pRxDesc)    GET_RX_DESC_RXPAYLOAD_MATCH(__pRxDesc)
#define GET_RX_DESC_RXPAYLOAD_ID_8822C(__pRxDesc)    GET_RX_DESC_RXPAYLOAD_ID(__pRxDesc)
#define GET_RX_DESC_DMA_AGG_NUM_8822C(__pRxDesc)    GET_RX_DESC_DMA_AGG_NUM(__pRxDesc)
#define GET_RX_DESC_BSSID_FIT_1_0_8822C(__pRxDesc)    GET_RX_DESC_BSSID_FIT_1_0(__pRxDesc)
#define GET_RX_DESC_EOSP_8822C(__pRxDesc)    GET_RX_DESC_EOSP(__pRxDesc)
#define GET_RX_DESC_HTC_8822C(__pRxDesc)    GET_RX_DESC_HTC(__pRxDesc)
#define GET_RX_DESC_BSSID_FIT_4_2_8822C(__pRxDesc)    GET_RX_DESC_BSSID_FIT_4_2(__pRxDesc)
#define GET_RX_DESC_RX_RATE_8822C(__pRxDesc)    GET_RX_DESC_RX_RATE(__pRxDesc)

/*RXDESC_WORD4*/

#define GET_RX_DESC_A1_FIT_8822C(__pRxDesc)    GET_RX_DESC_A1_FIT(__pRxDesc)
#define GET_RX_DESC_MACID_RPT_BUFF_8822C(__pRxDesc)    GET_RX_DESC_MACID_RPT_BUFF(__pRxDesc)
#define GET_RX_DESC_RX_PRE_NDP_VLD_8822C(__pRxDesc)    GET_RX_DESC_RX_PRE_NDP_VLD(__pRxDesc)
#define GET_RX_DESC_RX_SCRAMBLER_8822C(__pRxDesc)    GET_RX_DESC_RX_SCRAMBLER(__pRxDesc)
#define GET_RX_DESC_RX_EOF_8822C(__pRxDesc)    GET_RX_DESC_RX_EOF(__pRxDesc)
#define GET_RX_DESC_PATTERN_IDX_8822C(__pRxDesc)    GET_RX_DESC_PATTERN_IDX(__pRxDesc)

/*RXDESC_WORD5*/

#define GET_RX_DESC_TSFL_8822C(__pRxDesc)    GET_RX_DESC_TSFL(__pRxDesc)
