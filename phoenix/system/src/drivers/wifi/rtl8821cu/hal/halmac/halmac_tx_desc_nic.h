...
#define SET_TX_DESC_DMA_PRI(__pTxDesc, __Value)    SET_BITS_TO_LE_4BYTE(__pTxDesc + 0x08, 27, 1, __Value)
#define GET_TX_DESC_DMA_PRI(__pTxDesc)    LE_BITS_TO_4BYTE(__pTxDesc + 0x08, 27, 1)
...
#define SET_TX_DESC_MAX_AMSDU_MODE(__pTxDesc, __Value)    SET_BITS_TO_LE_4BYTE(__pTxDesc + 0x08, 24, 3, __Value)
#define GET_TX_DESC_MAX_AMSDU_MODE(__pTxDesc)    LE_BITS_TO_4BYTE(__pTxDesc + 0x08, 24, 3)
...
#define SET_TX_DESC_TXPWR_OFSET_TYPE(__pTxDesc, __Value)    SET_BITS_TO_LE_4BYTE(__pTxDesc + 0x14, 28, 2, __Value)
#define GET_TX_DESC_TXPWR_OFSET_TYPE(__pTxDesc)    LE_BITS_TO_4BYTE(__pTxDesc + 0x14, 28, 2)
