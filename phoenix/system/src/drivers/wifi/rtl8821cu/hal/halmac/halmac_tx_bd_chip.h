...
#define SET_TX_BD_OWN_8822C(__pTxBd, __Value)    SET_TX_BD_OWN(__pTxBd, __Value)
#define GET_TX_BD_OWN_8822C(__pTxBd)    GET_TX_BD_OWN(__pTxBd)
#define SET_TX_BD_PSB_8822C(__pTxBd, __Value)    SET_TX_BD_PSB(__pTxBd, __Value)
#define GET_TX_BD_PSB_8822C(__pTxBd)    GET_TX_BD_PSB(__pTxBd)
#define SET_TX_BD_TX_BUFF_SIZE0_8822C(__pTxBd, __Value)    SET_TX_BD_TX_BUFF_SIZE0(__pTxBd, __Value)
#define GET_TX_BD_TX_BUFF_SIZE0_8822C(__pTxBd)    GET_TX_BD_TX_BUFF_SIZE0(__pTxBd)

/*TXBD_DW1*/

#define SET_TX_BD_PHYSICAL_ADDR0_LOW_8822C(__pTxBd, __Value)    SET_TX_BD_PHYSICAL_ADDR0_LOW(__pTxBd, __Value)
#define GET_TX_BD_PHYSICAL_ADDR0_LOW_8822C(__pTxBd)    GET_TX_BD_PHYSICAL_ADDR0_LOW(__pTxBd)

/*TXBD_DW2*/

#define SET_TX_BD_PHYSICAL_ADDR0_HIGH_8822C(__pTxBd, __Value)    SET_TX_BD_PHYSICAL_ADDR0_HIGH(__pTxBd, __Value)
#define GET_TX_BD_PHYSICAL_ADDR0_HIGH_8822C(__pTxBd)    GET_TX_BD_PHYSICAL_ADDR0_HIGH(__pTxBd)

/*TXBD_DW4*/

#define SET_TX_BD_A1_8822C(__pTxBd, __Value)    SET_TX_BD_A1(__pTxBd, __Value)
#define GET_TX_BD_A1_8822C(__pTxBd)    GET_TX_BD_A1(__pTxBd)
#define SET_TX_BD_TX_BUFF_SIZE1_8822C(__pTxBd, __Value)    SET_TX_BD_TX_BUFF_SIZE1(__pTxBd, __Value)
#define GET_TX_BD_TX_BUFF_SIZE1_8822C(__pTxBd)    GET_TX_BD_TX_BUFF_SIZE1(__pTxBd)

/*TXBD_DW5*/

#define SET_TX_BD_PHYSICAL_ADDR1_LOW_8822C(__pTxBd, __Value)    SET_TX_BD_PHYSICAL_ADDR1_LOW(__pTxBd, __Value)
#define GET_TX_BD_PHYSICAL_ADDR1_LOW_8822C(__pTxBd)    GET_TX_BD_PHYSICAL_ADDR1_LOW(__pTxBd)

/*TXBD_DW6*/

#define SET_TX_BD_PHYSICAL_ADDR1_HIGH_8822C(__pTxBd, __Value)    SET_TX_BD_PHYSICAL_ADDR1_HIGH(__pTxBd, __Value)
#define GET_TX_BD_PHYSICAL_ADDR1_HIGH_8822C(__pTxBd)    GET_TX_BD_PHYSICAL_ADDR1_HIGH(__pTxBd)

/*TXBD_DW8*/

#define SET_TX_BD_A2_8822C(__pTxBd, __Value)    SET_TX_BD_A2(__pTxBd, __Value)
#define GET_TX_BD_A2_8822C(__pTxBd)    GET_TX_BD_A2(__pTxBd)
#define SET_TX_BD_TX_BUFF_SIZE2_8822C(__pTxBd, __Value)    SET_TX_BD_TX_BUFF_SIZE2(__pTxBd, __Value)
#define GET_TX_BD_TX_BUFF_SIZE2_8822C(__pTxBd)    GET_TX_BD_TX_BUFF_SIZE2(__pTxBd)

/*TXBD_DW9*/

#define SET_TX_BD_PHYSICAL_ADDR2_LOW_8822C(__pTxBd, __Value)    SET_TX_BD_PHYSICAL_ADDR2_LOW(__pTxBd, __Value)
#define GET_TX_BD_PHYSICAL_ADDR2_LOW_8822C(__pTxBd)    GET_TX_BD_PHYSICAL_ADDR2_LOW(__pTxBd)

/*TXBD_DW10*/

#define SET_TX_BD_PHYSICAL_ADDR2_HIGH_8822C(__pTxBd, __Value)    SET_TX_BD_PHYSICAL_ADDR2_HIGH(__pTxBd, __Value)
#define GET_TX_BD_PHYSICAL_ADDR2_HIGH_8822C(__pTxBd)    GET_TX_BD_PHYSICAL_ADDR2_HIGH(__pTxBd)

/*TXBD_DW12*/

#define SET_TX_BD_A3_8822C(__pTxBd, __Value)    SET_TX_BD_A3(__pTxBd, __Value)
#define GET_TX_BD_A3_8822C(__pTxBd)    GET_TX_BD_A3(__pTxBd)
#define SET_TX_BD_TX_BUFF_SIZE3_8822C(__pTxBd, __Value)    SET_TX_BD_TX_BUFF_SIZE3(__pTxBd, __Value)
#define GET_TX_BD_TX_BUFF_SIZE3_8822C(__pTxBd)    GET_TX_BD_TX_BUFF_SIZE3(__pTxBd)

/*TXBD_DW13*/

#define SET_TX_BD_PHYSICAL_ADDR3_LOW_8822C(__pTxBd, __Value)    SET_TX_BD_PHYSICAL_ADDR3_LOW(__pTxBd, __Value)
#define GET_TX_BD_PHYSICAL_ADDR3_LOW_8822C(__pTxBd)    GET_TX_BD_PHYSICAL_ADDR3_LOW(__pTxBd)

/*TXBD_DW14*/

#define SET_TX_BD_PHYSICAL_ADDR3_HIGH_8822C(__pTxBd, __Value)    SET_TX_BD_PHYSICAL_ADDR3_HIGH(__pTxBd, __Value)
#define GET_TX_BD_PHYSICAL_ADDR3_HIGH_8822C(__pTxBd)    GET_TX_BD_PHYSICAL_ADDR3_HIGH(__pTxBd)
