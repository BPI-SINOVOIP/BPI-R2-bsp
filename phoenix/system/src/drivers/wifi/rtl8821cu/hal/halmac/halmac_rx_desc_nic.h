...
#define GET_RX_DESC_RX_STATISTICS(__pRxDesc)    LE_BITS_TO_4BYTE(__pRxDesc + 0x08, 17, 1)
...
#define GET_RX_DESC_EOSP_V1(__pRxDesc)    LE_BITS_TO_4BYTE(__pRxDesc + 0x0C, 7, 1)
...
#define GET_RX_DESC_MACID_VLD_V1(__pRxDesc)    LE_BITS_TO_4BYTE(__pRxDesc + 0x10, 23, 1)
...
#define GET_RX_DESC_MACID_V1(__pRxDesc)    LE_BITS_TO_4BYTE(__pRxDesc + 0x10, 15, 8)
...
#define GET_RX_DESC_PATTERN_IDX_V1(__pRxDesc)    LE_BITS_TO_4BYTE(__pRxDesc + 0x10, 0, 5)
