...
#define FW_FWCTRL_RPT_GET_EVT_TYPE(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X00, 0, 8)
#define FW_FWCTRL_RPT_SET_EVT_TYPE(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X00, 0, 8, __Value)
#define FW_FWCTRL_RPT_GET_LENGTH(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X00, 8, 8)
#define FW_FWCTRL_RPT_SET_LENGTH(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X00, 8, 8, __Value)
#define FW_FWCTRL_RPT_GET_SEQ_NUM(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X00, 16, 8)
#define FW_FWCTRL_RPT_SET_SEQ_NUM(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X00, 16, 8, __Value)
#define FW_FWCTRL_RPT_GET_IS_ACK(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X00, 24, 1)
#define FW_FWCTRL_RPT_SET_IS_ACK(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X00, 24, 1, __Value)
#define FW_FWCTRL_RPT_GET_MORE_CONTENT(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X00, 25, 1)
#define FW_FWCTRL_RPT_SET_MORE_CONTENT(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X00, 25, 1, __Value)
#define FW_FWCTRL_RPT_GET_CONTENT_INDEX(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X00, 26, 6)
#define FW_FWCTRL_RPT_SET_CONTENT_INDEX(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X00, 26, 6, __Value)
#define FW_FWCTRL_RPT_GET_CLASS_ID(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X04, 0, 8)
#define FW_FWCTRL_RPT_SET_CLASS_ID(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X04, 0, 8, __Value)
#define FW_FWCTRL_RPT_GET_CONTENT(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X04, 16, 16)
#define FW_FWCTRL_RPT_SET_CONTENT(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X04, 16, 16, __Value)
#define H2C_LOOPBACK_ACK_GET_H2C_BYTE_0(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X04, 0, 8)
#define H2C_LOOPBACK_ACK_SET_H2C_BYTE_0(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X04, 0, 8, __Value)
#define H2C_LOOPBACK_ACK_GET_H2C_BYTE_1(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X04, 8, 8)
#define H2C_LOOPBACK_ACK_SET_H2C_BYTE_1(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X04, 8, 8, __Value)
#define H2C_LOOPBACK_ACK_GET_H2C_BYTE_2(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X04, 16, 8)
#define H2C_LOOPBACK_ACK_SET_H2C_BYTE_2(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X04, 16, 8, __Value)
#define H2C_LOOPBACK_ACK_GET_H2C_BYTE_3(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X04, 24, 8)
#define H2C_LOOPBACK_ACK_SET_H2C_BYTE_3(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X04, 24, 8, __Value)
#define H2C_LOOPBACK_ACK_GET_H2C_BYTE_4(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X8, 0, 8)
#define H2C_LOOPBACK_ACK_SET_H2C_BYTE_4(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X8, 0, 8, __Value)
#define H2C_LOOPBACK_ACK_GET_H2C_BYTE_5(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X8, 8, 8)
#define H2C_LOOPBACK_ACK_SET_H2C_BYTE_5(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X8, 8, 8, __Value)
#define H2C_LOOPBACK_ACK_GET_H2C_BYTE_6(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X8, 16, 8)
#define H2C_LOOPBACK_ACK_SET_H2C_BYTE_6(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X8, 16, 8, __Value)
#define H2C_LOOPBACK_ACK_GET_H2C_BYTE_7(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X8, 24, 8)
#define H2C_LOOPBACK_ACK_SET_H2C_BYTE_7(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X8, 24, 8, __Value)
#define FWCMD_LOOPBACK_ACK_GET_H2C_BYTE_0(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X04, 0, 8)
#define FWCMD_LOOPBACK_ACK_SET_H2C_BYTE_0(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X04, 0, 8, __Value)
#define FWCMD_LOOPBACK_ACK_GET_H2C_BYTE_1(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X04, 8, 8)
#define FWCMD_LOOPBACK_ACK_SET_H2C_BYTE_1(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X04, 8, 8, __Value)
#define FWCMD_LOOPBACK_ACK_GET_H2C_BYTE_2(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X04, 16, 8)
#define FWCMD_LOOPBACK_ACK_SET_H2C_BYTE_2(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X04, 16, 8, __Value)
#define FWCMD_LOOPBACK_ACK_GET_H2C_BYTE_3(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X04, 24, 8)
#define FWCMD_LOOPBACK_ACK_SET_H2C_BYTE_3(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X04, 24, 8, __Value)
#define FWCMD_LOOPBACK_ACK_GET_H2C_BYTE_4(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X8, 0, 8)
#define FWCMD_LOOPBACK_ACK_SET_H2C_BYTE_4(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X8, 0, 8, __Value)
#define FWCMD_LOOPBACK_ACK_GET_H2C_BYTE_5(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X8, 8, 8)
#define FWCMD_LOOPBACK_ACK_SET_H2C_BYTE_5(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X8, 8, 8, __Value)
#define FWCMD_LOOPBACK_ACK_GET_H2C_BYTE_6(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X8, 16, 8)
#define FWCMD_LOOPBACK_ACK_SET_H2C_BYTE_6(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X8, 16, 8, __Value)
#define FWCMD_LOOPBACK_ACK_GET_H2C_BYTE_7(__pC2H)    LE_BITS_TO_4BYTE(__pC2H + 0X8, 24, 8)
#define FWCMD_LOOPBACK_ACK_SET_H2C_BYTE_7(__pC2H, __Value)    SET_BITS_TO_LE_4BYTE(__pC2H + 0X8, 24, 8, __Value)
#endif
