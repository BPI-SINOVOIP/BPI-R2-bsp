...
struct halmac_wlan_pwr_cfg HALMAC_RTL8821C_TRANS_CARDEMU_TO_ACT[] = {
	...
	{0x007C, HALMAC_PWR_CUT_ALL_MSK, HALMAC_PWR_FAB_ALL_MSK, HALMAC_PWR_INTF_ALL_MSK, HALMAC_PWR_BASEADDR_MAC, HALMAC_PWR_CMD_WRITE, BIT(1), 0 }, /*Modify SWR freq to 2.4MHz*/
	{0xFFFF, HALMAC_PWR_CUT_ALL_MSK, HALMAC_PWR_FAB_ALL_MSK, HALMAC_PWR_INTF_ALL_MSK, 0, HALMAC_PWR_CMD_END, 0, 0},
};

struct halmac_wlan_pwr_cfg HALMAC_RTL8821C_TRANS_ACT_TO_CARDEMU[] = {
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value } */
...
struct halmac_wlan_pwr_cfg HALMAC_RTL8821C_TRANS_CARDEMU_TO_SUS[] = {
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value } */
...
struct halmac_wlan_pwr_cfg HALMAC_RTL8821C_TRANS_SUS_TO_CARDEMU[] = {
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value } */
...
struct halmac_wlan_pwr_cfg HALMAC_RTL8821C_TRANS_CARDEMU_TO_CARDDIS[] = {
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value } */
...
struct halmac_wlan_pwr_cfg HALMAC_RTL8821C_TRANS_CARDDIS_TO_CARDEMU[] = {
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value } */
	{0x0086, HALMAC_PWR_CUT_ALL_MSK, HALMAC_PWR_FAB_ALL_MSK, HALMAC_PWR_INTF_SDIO_MSK, HALMAC_PWR_BASEADDR_SDIO, HALMAC_PWR_CMD_WRITE, BIT(0), 0}, /*Set SDIO suspend local register*/
	{0x0086, HALMAC_PWR_CUT_ALL_MSK, HALMAC_PWR_FAB_ALL_MSK, HALMAC_PWR_INTF_SDIO_MSK, HALMAC_PWR_BASEADDR_SDIO, HALMAC_PWR_CMD_POLLING, BIT(1), BIT(1)}, /*wait power state to suspend*/
	...
	{0x0300, HALMAC_PWR_CUT_ALL_MSK, HALMAC_PWR_FAB_ALL_MSK, HALMAC_PWR_INTF_PCI_MSK, HALMAC_PWR_BASEADDR_MAC, HALMAC_PWR_CMD_WRITE, 0xFF, 0}, /*PCIe DMA start*/
...
struct halmac_wlan_pwr_cfg HALMAC_RTL8821C_TRANS_CARDEMU_TO_PDN[] = {
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value } */
...
struct halmac_wlan_pwr_cfg HALMAC_RTL8821C_TRANS_PDN_TO_CARDEMU[] = {
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value } */
...
struct halmac_wlan_pwr_cfg HALMAC_RTL8821C_TRANS_ACT_TO_LPS[] = {
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value } */
...
struct halmac_wlan_pwr_cfg HALMAC_RTL8821C_TRANS_ACT_TO_DEEP_LPS[] = {
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value } */
	{0x0101, HALMAC_PWR_CUT_ALL_MSK, HALMAC_PWR_FAB_ALL_MSK, HALMAC_PWR_INTF_ALL_MSK, HALMAC_PWR_BASEADDR_MAC, HALMAC_PWR_CMD_WRITE, BIT(2), BIT(2)}, /*Enable 32k calibration and thermal meter*/
	{0x0199, HALMAC_PWR_CUT_ALL_MSK, HALMAC_PWR_FAB_ALL_MSK, HALMAC_PWR_INTF_ALL_MSK, HALMAC_PWR_BASEADDR_MAC, HALMAC_PWR_CMD_WRITE, BIT(3), BIT(3)}, /*Register write data of 32K calibration*/
	{0x019B, HALMAC_PWR_CUT_ALL_MSK, HALMAC_PWR_FAB_ALL_MSK, HALMAC_PWR_INTF_ALL_MSK, HALMAC_PWR_BASEADDR_MAC, HALMAC_PWR_CMD_WRITE, BIT(7), BIT(7)}, /*Enable 32k calibration reg write*/
...
struct halmac_wlan_pwr_cfg HALMAC_RTL8821C_TRANS_LPS_TO_ACT[] = {
	/* { offset, cut_msk, fab_msk|interface_msk, base|cmd, msk, value } */
	...
	{0x03D9, HALMAC_PWR_CUT_ALL_MSK, HALMAC_PWR_FAB_ALL_MSK, HALMAC_PWR_INTF_PCI_MSK, HALMAC_PWR_BASEADDR_MAC, HALMAC_PWR_CMD_WRITE, BIT(7), BIT(7)}, /*PCIe RPWM*/
	{0x0002, HALMAC_PWR_CUT_ALL_MSK, HALMAC_PWR_FAB_ALL_MSK, HALMAC_PWR_INTF_PCI_MSK, HALMAC_PWR_BASEADDR_MAC, HALMAC_PWR_CMD_DELAY, 0, HALMAC_PWRSEQ_DELAY_MS}, /*Delay*/
	{0x03D9, HALMAC_PWR_CUT_ALL_MSK, HALMAC_PWR_FAB_ALL_MSK, HALMAC_PWR_INTF_PCI_MSK, HALMAC_PWR_BASEADDR_MAC, HALMAC_PWR_CMD_WRITE, BIT(7), 0}, /*PCIe RPWM*/
	{0x0002, HALMAC_PWR_CUT_ALL_MSK, HALMAC_PWR_FAB_ALL_MSK, HALMAC_PWR_INTF_ALL_MSK, HALMAC_PWR_BASEADDR_MAC, HALMAC_PWR_CMD_DELAY, 0, HALMAC_PWRSEQ_DELAY_MS}, /*Delay*/
...
/* Card Enable Array */
struct halmac_wlan_pwr_cfg *halmac_8821c_card_enable_flow[] = {
...
/* Card Disable Array */
struct halmac_wlan_pwr_cfg *halmac_8821c_card_disable_flow[] = {
...
/* Suspend Array */
struct halmac_wlan_pwr_cfg *halmac_8821c_suspend_flow[] = {
	HALMAC_RTL8821C_TRANS_ACT_TO_CARDEMU,
...
/* Resume Array */
struct halmac_wlan_pwr_cfg *halmac_8821c_resume_flow[] = {
...
struct halmac_wlan_pwr_cfg *halmac_8821c_hwpdn_flow[] = {
	NULL
};

/* Enter LPS - FW behavior */
struct halmac_wlan_pwr_cfg *halmac_8821c_enter_lps_flow[] = {
	HALMAC_RTL8821C_TRANS_ACT_TO_LPS,
	NULL
};

/* Enter Deep LPS - FW behavior */
struct halmac_wlan_pwr_cfg *halmac_8821c_enter_deep_lps_flow[] = {
	HALMAC_RTL8821C_TRANS_ACT_TO_DEEP_LPS,
	NULL
};

/* Leave LPS -FW behavior */
struct halmac_wlan_pwr_cfg *halmac_8821c_leave_lps_flow[] = {
