...
#define CHANNEL_SWITCH_GET_NORMAL_PERIOD(__pH2C)    GET_H2C_FIELD(__pH2C + 0X0C, 8, 6)
#define CHANNEL_SWITCH_SET_NORMAL_PERIOD(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X0C, 8, 6, __Value)
#define CHANNEL_SWITCH_SET_NORMAL_PERIOD_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X0C, 8, 6, __Value)
#define CHANNEL_SWITCH_GET_NORMAL_PERIOD_SEL(__pH2C)    GET_H2C_FIELD(__pH2C + 0X0C, 14, 2)
#define CHANNEL_SWITCH_SET_NORMAL_PERIOD_SEL(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X0C, 14, 2, __Value)
#define CHANNEL_SWITCH_SET_NORMAL_PERIOD_SEL_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X0C, 14, 2, __Value)
#define CHANNEL_SWITCH_GET_SLOW_PERIOD(__pH2C)    GET_H2C_FIELD(__pH2C + 0X0C, 16, 6)
#define CHANNEL_SWITCH_SET_SLOW_PERIOD(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X0C, 16, 6, __Value)
#define CHANNEL_SWITCH_SET_SLOW_PERIOD_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X0C, 16, 6, __Value)
#define CHANNEL_SWITCH_GET_SLOW_PERIOD_SEL(__pH2C)    GET_H2C_FIELD(__pH2C + 0X0C, 22, 2)
#define CHANNEL_SWITCH_SET_SLOW_PERIOD_SEL(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X0C, 22, 2, __Value)
#define CHANNEL_SWITCH_SET_SLOW_PERIOD_SEL_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X0C, 22, 2, __Value)
...
#define P2PPS_GET_DISABLE_CLOSERF(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 7, 1)
#define P2PPS_SET_DISABLE_CLOSERF(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 7, 1, __Value)
#define P2PPS_SET_DISABLE_CLOSERF_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 7, 1, __Value)
...
#define NAN_CTRL_GET_WARMUP_TIMER_FLAG(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 2, 1)
#define NAN_CTRL_SET_WARMUP_TIMER_FLAG(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 2, 1, __Value)
#define NAN_CTRL_SET_WARMUP_TIMER_FLAG_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 2, 1, __Value)
...
#define NAN_CTRL_GET_MASTERPREFERENCE_VALUE(__pH2C)    GET_H2C_FIELD(__pH2C + 0X0C, 8, 8)
#define NAN_CTRL_SET_MASTERPREFERENCE_VALUE(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X0C, 8, 8, __Value)
#define NAN_CTRL_SET_MASTERPREFERENCE_VALUE_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X0C, 8, 8, __Value)
#define NAN_CTRL_GET_RANDOMFACTOR_VALUE(__pH2C)    GET_H2C_FIELD(__pH2C + 0X0C, 16, 8)
#define NAN_CTRL_SET_RANDOMFACTOR_VALUE(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X0C, 16, 8, __Value)
#define NAN_CTRL_SET_RANDOMFACTOR_VALUE_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X0C, 16, 8, __Value)
...
#define FW_ACCESS_TEST_GET_ACCESS_TXFF(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 0, 1)
#define FW_ACCESS_TEST_SET_ACCESS_TXFF(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 0, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_TXFF_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 0, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_RXFF(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 1, 1)
#define FW_ACCESS_TEST_SET_ACCESS_RXFF(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 1, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_RXFF_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 1, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_FWFF(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 2, 1)
#define FW_ACCESS_TEST_SET_ACCESS_FWFF(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 2, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_FWFF_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 2, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_PHYFF(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 3, 1)
#define FW_ACCESS_TEST_SET_ACCESS_PHYFF(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 3, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_PHYFF_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 3, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_RPT_BUF(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 4, 1)
#define FW_ACCESS_TEST_SET_ACCESS_RPT_BUF(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 4, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_RPT_BUF_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 4, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_CAM(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 5, 1)
#define FW_ACCESS_TEST_SET_ACCESS_CAM(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 5, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_CAM_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 5, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_WOW_CAM(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 6, 1)
#define FW_ACCESS_TEST_SET_ACCESS_WOW_CAM(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 6, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_WOW_CAM_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 6, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_RX_CAM(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 7, 1)
#define FW_ACCESS_TEST_SET_ACCESS_RX_CAM(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 7, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_RX_CAM_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 7, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_BA_CAM(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 8, 1)
#define FW_ACCESS_TEST_SET_ACCESS_BA_CAM(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 8, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_BA_CAM_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 8, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_MBSSID_CAM(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 9, 1)
#define FW_ACCESS_TEST_SET_ACCESS_MBSSID_CAM(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 9, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_MBSSID_CAM_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 9, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_PAGE0(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 16, 1)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE0(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 16, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE0_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 16, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_PAGE1(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 17, 1)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE1(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 17, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE1_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 17, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_PAGE2(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 18, 1)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE2(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 18, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE2_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 18, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_PAGE3(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 19, 1)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE3(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 19, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE3_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 19, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_PAGE4(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 20, 1)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE4(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 20, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE4_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 20, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_PAGE5(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 21, 1)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE5(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 21, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE5_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 21, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_PAGE6(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 22, 1)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE6(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 22, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE6_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 22, 1, __Value)
#define FW_ACCESS_TEST_GET_ACCESS_PAGE7(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 23, 1)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE7(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 23, 1, __Value)
#define FW_ACCESS_TEST_SET_ACCESS_PAGE7_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 23, 1, __Value)
#define PHYDM_INFO_GET_REF_TYPE(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 0, 8)
#define PHYDM_INFO_SET_REF_TYPE(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 0, 8, __Value)
#define PHYDM_INFO_SET_REF_TYPE_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 0, 8, __Value)
#define PHYDM_INFO_GET_RF_TYPE(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 8, 8)
#define PHYDM_INFO_SET_RF_TYPE(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 8, 8, __Value)
#define PHYDM_INFO_SET_RF_TYPE_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 8, 8, __Value)
#define PHYDM_INFO_GET_CUT_VER(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 16, 8)
#define PHYDM_INFO_SET_CUT_VER(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 16, 8, __Value)
#define PHYDM_INFO_SET_CUT_VER_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 16, 8, __Value)
#define PHYDM_INFO_GET_RX_ANT_STATUS(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 24, 4)
#define PHYDM_INFO_SET_RX_ANT_STATUS(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 24, 4, __Value)
#define PHYDM_INFO_SET_RX_ANT_STATUS_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 24, 4, __Value)
#define PHYDM_INFO_GET_TX_ANT_STATUS(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 28, 4)
#define PHYDM_INFO_SET_TX_ANT_STATUS(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 28, 4, __Value)
#define PHYDM_INFO_SET_TX_ANT_STATUS_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 28, 4, __Value)
#define FW_SNDING_GET_SU0(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 0, 1)
#define FW_SNDING_SET_SU0(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 0, 1, __Value)
#define FW_SNDING_SET_SU0_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 0, 1, __Value)
#define FW_SNDING_GET_SU1(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 1, 1)
#define FW_SNDING_SET_SU1(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 1, 1, __Value)
#define FW_SNDING_SET_SU1_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 1, 1, __Value)
#define FW_SNDING_GET_MU(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 2, 1)
#define FW_SNDING_SET_MU(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 2, 1, __Value)
#define FW_SNDING_SET_MU_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 2, 1, __Value)
#define FW_SNDING_GET_PERIOD(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 8, 8)
#define FW_SNDING_SET_PERIOD(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 8, 8, __Value)
#define FW_SNDING_SET_PERIOD_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 8, 8, __Value)
#define FW_SNDING_GET_NDPA0_HEAD_PG(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 16, 8)
#define FW_SNDING_SET_NDPA0_HEAD_PG(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 16, 8, __Value)
#define FW_SNDING_SET_NDPA0_HEAD_PG_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 16, 8, __Value)
#define FW_SNDING_GET_NDPA1_HEAD_PG(__pH2C)    GET_H2C_FIELD(__pH2C + 0X08, 24, 8)
#define FW_SNDING_SET_NDPA1_HEAD_PG(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0X08, 24, 8, __Value)
#define FW_SNDING_SET_NDPA1_HEAD_PG_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0X08, 24, 8, __Value)
#define FW_SNDING_GET_MU_NDPA_HEAD_PG(__pH2C)    GET_H2C_FIELD(__pH2C + 0XC, 0, 8)
#define FW_SNDING_SET_MU_NDPA_HEAD_PG(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0XC, 0, 8, __Value)
#define FW_SNDING_SET_MU_NDPA_HEAD_PG_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0XC, 0, 8, __Value)
#define FW_SNDING_GET_RPT0_HEAD_PG(__pH2C)    GET_H2C_FIELD(__pH2C + 0XC, 8, 8)
#define FW_SNDING_SET_RPT0_HEAD_PG(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0XC, 8, 8, __Value)
#define FW_SNDING_SET_RPT0_HEAD_PG_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0XC, 8, 8, __Value)
#define FW_SNDING_GET_RPT1_HEAD_PG(__pH2C)    GET_H2C_FIELD(__pH2C + 0XC, 16, 8)
#define FW_SNDING_SET_RPT1_HEAD_PG(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0XC, 16, 8, __Value)
#define FW_SNDING_SET_RPT1_HEAD_PG_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0XC, 16, 8, __Value)
#define FW_SNDING_GET_RPT2_HEAD_PG(__pH2C)    GET_H2C_FIELD(__pH2C + 0XC, 24, 8)
#define FW_SNDING_SET_RPT2_HEAD_PG(__pH2C, __Value)    SET_H2C_FIELD_CLR(__pH2C + 0XC, 24, 8, __Value)
#define FW_SNDING_SET_RPT2_HEAD_PG_NO_CLR(__pH2C, __Value)    SET_H2C_FIELD_NO_CLR(__pH2C + 0XC, 24, 8, __Value)
#endif
