...
const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO0_8821C[] = {
...
const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO1_8821C[] = {
...
const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO2_8821C[] = {
...
const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO3_8821C[] = {
...
const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO4_8821C[] = {
...
const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO5_8821C[] = {
...
const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO6_8821C[] = {
...
const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO7_8821C[] = {
...
const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO8_8821C[] = {
	HALMAC_GPIO8_WL_EXT_WOL_8821C,
	HALMAC_GPIO8_WL_LED_8821C,
	HALMAC_GPIO8_SW_IO_8821C
};

const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO9_8821C[] = {
...
const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO10_8821C[] = {
	HALMAC_GPIO10_SW_IO_8821C
};

const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO11_8821C[] = {
	HALMAC_GPIO11_DIS_BT_N_8821C,
	HALMAC_GPIO11_USOUT0_8821C,
	HALMAC_GPIO11_SW_IO_8821C
};

const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO12_8821C[] = {
	HALMAC_GPIO12_USIN0_8821C,
	HALMAC_GPIO12_SW_IO_8821C
};

const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO13_8821C[] = {
	HALMAC_GPIO13_BT_WAKE_8821C,
	HALMAC_GPIO13_SW_IO_8821C
};

const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO14_8821C[] = {
	HALMAC_GPIO14_UART_WAKE_8821C,
	HALMAC_GPIO14_SW_IO_8821C
};

const HALMAC_GPIO_PIMUX_LIST PIMUX_LIST_GPIO15_8821C[] = {
...
)
{
	...
	PLATFORM_MSG_PRINT(pDriver_adapter, HALMAC_MSG_COMMON, HALMAC_DBG_TRACE, "[TRACE]halmac_pinmux_get_func_8821c ==========>\n");

	status = halmac_get_pinmux_list_8821c(pHalmac_adapter, gpio_func, &pPinmux_list, &list_size, &gpio_id);
...
)
{
	...
	PLATFORM_MSG_PRINT(pDriver_adapter, HALMAC_MSG_COMMON, HALMAC_DBG_TRACE, "[TRACE]halmac_pinmux_set_func_8821c ==========>\n");
	PLATFORM_MSG_PRINT(pDriver_adapter, HALMAC_MSG_COMMON, HALMAC_DBG_TRACE, "[TRACE]func name : %d\n", gpio_func);

	status = halmac_chk_pinmux_valid_8821c(pHalmac_adapter, gpio_func);
	if (status != HALMAC_RET_SUCCESS)
		return status;
...
)
{
	...
	PLATFORM_MSG_PRINT(pDriver_adapter, HALMAC_MSG_COMMON, HALMAC_DBG_TRACE, "[TRACE]halmac_pinmux_free_func_8821c ==========>\n");
...
)
{
	switch (gpio_func) {
	case HALMAC_GPIO_FUNC_SW_IO_0:
		*ppPinmux_list = PIMUX_LIST_GPIO0_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO0_8821C);
		*pGpio_id = HALMAC_GPIO0;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_1:
		*ppPinmux_list = PIMUX_LIST_GPIO1_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO1_8821C);
		*pGpio_id = HALMAC_GPIO1;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_2:
		*ppPinmux_list = PIMUX_LIST_GPIO2_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO2_8821C);
		*pGpio_id = HALMAC_GPIO2;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_3:
		*ppPinmux_list = PIMUX_LIST_GPIO3_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO3_8821C);
		*pGpio_id = HALMAC_GPIO3;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_4:
	case HALMAC_GPIO_FUNC_SDIO_INT:
		*ppPinmux_list = PIMUX_LIST_GPIO4_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO4_8821C);
		*pGpio_id = HALMAC_GPIO4;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_5:
		*ppPinmux_list = PIMUX_LIST_GPIO5_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO5_8821C);
		*pGpio_id = HALMAC_GPIO5;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_6:
		*ppPinmux_list = PIMUX_LIST_GPIO6_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO6_8821C);
		*pGpio_id = HALMAC_GPIO6;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_7:
		*ppPinmux_list = PIMUX_LIST_GPIO7_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO7_8821C);
		*pGpio_id = HALMAC_GPIO7;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_8:
	case HALMAC_GPIO_FUNC_WL_LED:
		*ppPinmux_list = PIMUX_LIST_GPIO8_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO8_8821C);
		*pGpio_id = HALMAC_GPIO8;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_9:
		*ppPinmux_list = PIMUX_LIST_GPIO9_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO9_8821C);
		*pGpio_id = HALMAC_GPIO9;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_10:
		*ppPinmux_list = PIMUX_LIST_GPIO10_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO10_8821C);
		*pGpio_id = HALMAC_GPIO10;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_11:
		*ppPinmux_list = PIMUX_LIST_GPIO11_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO11_8821C);
		*pGpio_id = HALMAC_GPIO11;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_12:
		*ppPinmux_list = PIMUX_LIST_GPIO12_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO12_8821C);
		*pGpio_id = HALMAC_GPIO12;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_13:
		*ppPinmux_list = PIMUX_LIST_GPIO13_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO13_8821C);
		*pGpio_id = HALMAC_GPIO13;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_14:
		*ppPinmux_list = PIMUX_LIST_GPIO14_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO14_8821C);
		*pGpio_id = HALMAC_GPIO14;
		break;
	case HALMAC_GPIO_FUNC_SW_IO_15:
		*ppPinmux_list = PIMUX_LIST_GPIO15_8821C;
		*pList_size = ARRAY_SIZE(PIMUX_LIST_GPIO15_8821C);
