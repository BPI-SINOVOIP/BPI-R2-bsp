...
#define GET_RX_DESC_EVT_PKT(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword0, 0x1, 28)
...
#define GET_RX_DESC_TYPE(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword1, 0x3, 28)
...
#define GET_RX_DESC_A1_MATCH(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword1, 0x1, 24)
...
#define GET_RX_DESC_TCP_CHKSUM_VLD(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword1, 0x1, 23)
...
#define GET_RX_DESC_TCP_CHKSUM_ERR(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword1, 0x1, 20)
#define GET_RX_DESC_PHY_PKT_IDC(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword1, 0x1, 17)
#define GET_RX_DESC_FW_FIFO_FULL(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword1, 0x1, 16)
...
#define GET_RX_DESC_AMPDU(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword1, 0x1, 15)
...
#define GET_RX_DESC_RXCMD_IDC(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword1, 0x1, 14)
...
#define GET_RX_DESC_AMSDU_CUT(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword2, 0x1, 31)
...
#define GET_RX_DESC_RXMAGPKT(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword2, 0x1, 24)
...
#define GET_RX_DESC_LAST_MSDU(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword2, 0x1, 17)
...
#define GET_RX_DESC_EXT_SEC_TYPE(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword2, 0x1, 16)
...
#define GET_RX_DESC_PATTERN_WAKE(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword3, 0x1, 29)
...
#define GET_RX_DESC_BSSID_FIT(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword3, 0x1f, 11)
...
#define GET_RX_DESC_AMPDU_END_PKT(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword3, 0x1, 9)
#define GET_RX_DESC_ADDRESS_CAM_VLD(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword3, 0x1, 8)
...
#define GET_RX_DESC_ADDRESS_CAM(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword4, 0xff, 24)
...
#define GET_RX_DESC_FC_POWER(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword4, 0x1, 7)

#endif

#if (HALMAC_8198F_SUPPORT)

#define GET_RX_DESC_TXRPTMID_CTL_MASK(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword4, 0x1, 6)

#endif

#if (HALMAC_8814B_SUPPORT || HALMAC_8198F_SUPPORT)

#define GET_RX_DESC_SWPS_RPT(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword4, 0x1, 5)
...
#define GET_RX_DESC_FREERUN_CNT(__pRxDesc)    HALMAC_GET_DESC_FIELD(((PHALMAC_RX_DESC)__pRxDesc)->Dword5, 0xffffffff, 0)
