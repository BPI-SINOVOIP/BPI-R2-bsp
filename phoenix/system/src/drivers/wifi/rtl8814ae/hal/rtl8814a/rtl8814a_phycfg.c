...
)
{
	...
	case RF_3T3R:
		...
		PHY_SetBBReg(Adapter, rCCK0_FalseAlarmReport, BIT18|BIT22, 0);
...
)
{
	...
	/* RTW_INFO("==>phy_BB8814A_Config_ParaFile\n"); */

	pszBBRegFile = sz8814ABBRegFile ;
	pszAGCTableFile = sz8814AAGCTableFile;


	/* RTW_INFO(" ===> phy_BB8814A_Config_ParaFile() phy_reg:%s\n",pszBBRegFile); */
	/* RTW_INFO(" ===> phy_BB8814A_Config_ParaFile() phy_reg_pg:%s\n",pszBBRegPgFile); */
	/* RTW_INFO(" ===> phy_BB8814A_Config_ParaFile() agc_table:%s\n",pszAGCTableFile); */
...
RT_STATUS PHY_BBConfigMP_8814A(PADAPTER	Adapter)
{
	...
	RTW_INFO(" ===> PHY_BBConfigMP_8814A() phy_reg_mp:%s\n", pszBBRegMpFile);
...
)
{
	...
	if (bInit) {
		...
		switch (pHalData->RFEType) {
		case 2:
			PHY_SetBBReg(Adapter, rA_RFE_Pinmux_Jaguar, bMaskDWord, 0x37173717);	/* 0xCB0 = 0x37173717 */
			PHY_SetBBReg(Adapter, rB_RFE_Pinmux_Jaguar, bMaskDWord, 0x37173717);	/* 0xEB0 = 0x37173717 */
			PHY_SetBBReg(Adapter, rC_RFE_Pinmux_Jaguar, bMaskDWord, 0x37173717);	/* 0x18B4 = 0x37173717 */
