...
#if ((RTL8723D_SUPPORT == 1) || (RTL8822B_SUPPORT == 1) || (RTL8197F_SUPPORT == 1) || (RTL8821C_SUPPORT == 1))

	if (pDM_Odm->SupportICType & (ODM_RTL8723D|ODM_RTL8822B|ODM_RTL8197F|ODM_RTL8821C)) {
...
)
{
	...
	if (pDM_Odm->SupportICType & ODM_RTL8821C)
		phydm_init_hw_info_by_rfe_type_8821c(pDM_Odm);
#endif
}
