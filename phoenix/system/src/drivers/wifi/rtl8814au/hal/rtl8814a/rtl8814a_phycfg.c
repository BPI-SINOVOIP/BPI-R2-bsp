	...
	)
{
	...
	case RF_1T1R:
		...
		break;
	case RF_2T4R:
		/*RX CCK enable 2R CCA*/
		PHY_SetBBReg(Adapter, rCCK0_FalseAlarmReport+2, BIT2|BIT6, 0x11);
		/*pathB/C tx on, path A/D tx off*/
		PHY_SetBBReg(Adapter, rCCK_RX_Jaguar, 0xf0000000, 0x6);
		break;
	case RF_3T3R:
		/*RX CCK enable 2R CCA*/
		PHY_SetBBReg(Adapter, rCCK0_FalseAlarmReport+2, BIT2|BIT6, 0x11);
		/*pathB/C/D tx on, path A tx off*/
		PHY_SetBBReg(Adapter, rCCK_RX_Jaguar, 0xf0000000, 0x7);
		break;
	default:
		/*RX CCK enable 2R CCA*/
		PHY_SetBBReg(Adapter, rCCK0_FalseAlarmReport+2, BIT2|BIT6, 0x11);
