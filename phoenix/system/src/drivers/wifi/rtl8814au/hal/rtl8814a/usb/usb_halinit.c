...
HAL_INIT_PROFILE_TAG(HAL_INIT_STAGES_MISC31);
	...
	/* Bug 46566: Pace only bug, avoid rx under flow(REG_RXDMA_STATUS:0x00000010) happen, but not really fix this issue */
	//This is a workaround solution, disable it by default and check whether this issue happened again.
	//rtw_write8(Adapter, 0xf01d, rtw_read8(Adapter,0xf01d)|BIT1);

#ifdef CONFIG_DISABLE_TX_EMPHASIS
#ifdef DEBUG_DISABLE_TX_EMPHASIS
	DBG_871X("U3PHY: Original Value\n");
	DBG_871X("U3PHY: Page 0 Reg[0x00]=0x%04x\n", rtw_read_usb3_phy(Adapter, 0x00) );
	DBG_871X("U3PHY: Page 0 Reg[0x01]=0x%04x\n", rtw_read_usb3_phy(Adapter, 0x01) );
	DBG_871X("U3PHY: Page 0 Reg[0x0A]=0x%04x\n", rtw_read_usb3_phy(Adapter, 0x0A) );
	DBG_871X("U3PHY: Page 0 Reg[0x0C]=0x%04x\n", rtw_read_usb3_phy(Adapter, 0x0C) );
	DBG_871X("U3PHY: Page 0 Reg[0x0D]=0x%04x\n", rtw_read_usb3_phy(Adapter, 0x0D) );
	DBG_871X("U3PHY: Page 0 Reg[0x19]=0x%04x\n", rtw_read_usb3_phy(Adapter, 0x19) );
	DBG_871X("U3PHY: Page 0 Reg[0x1E]=0x%04x\n", rtw_read_usb3_phy(Adapter, 0x1E) );
	DBG_871X("U3PHY: Page 1 Reg[0x04]=0x%04x\n", rtw_read_usb3_phy(Adapter, 0x24) );
#endif	//DEBUG_DISABLE_TX_EMPHASIS

	//USB3 PHY
	//Page 0 : REG 0x0D[7:5] = 3'b000
	rtw_write_usb3_phy(Adapter, 0x0D, rtw_read_usb3_phy(Adapter, 0x0D)&~(BIT5|BIT6|BIT7) );
	//Page 0 : REG 0x1E[6] = 1'b0
	rtw_write_usb3_phy(Adapter, 0x1E, rtw_read_usb3_phy(Adapter, 0x1E)&~BIT6 );
	//Page 1 : REG 0x04[12:11] = 2'b00
	rtw_write_usb3_phy(Adapter, 0x24, rtw_read_usb3_phy(Adapter, 0x24)&~(BIT11|BIT12) );

#ifdef DEBUG_DISABLE_TX_EMPHASIS
	DBG_871X("U3PHY: New Value\n");
	DBG_871X("U3PHY: Page 0 Reg[0x00]=0x%04x\n", rtw_read_usb3_phy(Adapter, 0x00) );
	DBG_871X("U3PHY: Page 0 Reg[0x01]=0x%04x\n", rtw_read_usb3_phy(Adapter, 0x01) );
	DBG_871X("U3PHY: Page 0 Reg[0x0A]=0x%04x\n", rtw_read_usb3_phy(Adapter, 0x0A) );
	DBG_871X("U3PHY: Page 0 Reg[0x0C]=0x%04x\n", rtw_read_usb3_phy(Adapter, 0x0C) );
	...
	DBG_871X("U3PHY: Page 1 Reg[0x04]=0x%04x\n", rtw_read_usb3_phy(Adapter, 0x24) );
#endif	//DEBUG_DISABLE_TX_EMPHASIS
#endif	//CONFIG_DISABLE_TX_EMPHASIS
